...
export type EbookHeroPortraitSectionProps = {
...
/** Isabella portrait hero (`hero_done.png`) — layout tuned for the tall cutout. */
export default function EbookHeroPortraitSection({
  hero,
  checkoutUrl,
  timeToResult,
  asset,
