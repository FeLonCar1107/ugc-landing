...
export default function About(props: IAboutProps) {
  ...
  return (
    <section
      data-scroll-section
      id="about"
      className="tw-section-y flex w-screen items-center justify-center"
    >
      <div className="section-shell w-full">
        <div className="grid w-full grid-cols-1 gap-x-12 gap-y-10 lg:grid-cols-[minmax(0,1fr)_minmax(17.5rem,26.25rem)] lg:items-start lg:gap-x-16 lg:gap-y-6 xl:gap-x-24 xl:gap-y-8">
          <header className="min-w-0 space-y-0.5 lg:col-start-1 lg:row-start-1">
            <p className="tw-eyebrow text-center lg:text-left">{title}</p>
            <h2 className="tw-section-heading tw-text-heading text-center font-bold lg:text-left">
              {subtitle}
            </h2>
          </header>

          <div className="flex w-full justify-center lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:justify-end">
            <div className="relative aspect-[3/4] w-full max-w-[min(100%,380px)] overflow-hidden rounded-2xl bg-jazzberry-jam-100 shadow-[0_24px_60px_-20px_rgba(157,23,77,0.14)] sm:max-w-[420px]">
              <Image
          ...
          <div className="flex w-full min-w-0 flex-col justify-start lg:col-start-1 lg:row-start-2">
            <div className="tw-body-readable space-y-5">
