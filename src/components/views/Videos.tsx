  ...
  return (
    ...
    >
      <div className="w-[73%] h-auto max-w-[1350px]">
        <div className="bg-jazzberry-jam-200 w-full h-[35vw] max-h-[250px] text-[25px] md:text-[40px] xl:text-[50px] text-white text-center flex flex-col space-y-[-10px] md:space-y-0 md:flex-row md:justify-center md:gap-3 uppercase pt-[5vw] 2xl:pt-[3vw] shadow-sm">
          <h2>
