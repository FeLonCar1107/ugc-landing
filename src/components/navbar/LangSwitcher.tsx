...
export default function LangSwitcher({ currentLanguage }: ILangSwitcherProps) {
  ...
  return (
    <button
      className="w-[20px] h-[15px] rounded-full bg-jazzberry-jam-400 flex items-center transition duration-300 focus:outline-none shadow animated fadeIn"
      onClick={handleLanguageChange}
    >
      <div
        id="switch-toggle"
        className={`w-[20px] h-[20px] relative rounded-full transition duration-500 transform ${
